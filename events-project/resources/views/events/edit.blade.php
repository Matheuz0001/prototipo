                        ...
                        <div class="space-y-6 pt-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="event_date" class="flatpickr-datetime block mt-1 w-full bg-[#121214] border-white/10 focus:border-indigo-500 focus:ring-indigo-500 rounded-2xl shadow-sm text-[#f0eee9]" type="text" name="event_date" :value="old('event_date', $event->event_date->format('Y-m-d H:i'))" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="registration_deadline" class="flatpickr-datetime block mt-1 w-full bg-[#121214] border-white/10 focus:border-indigo-500 focus:ring-indigo-500 rounded-2xl shadow-sm text-[#f0eee9]" type="text" name="registration_deadline" :value="old('registration_deadline', $event->registration_deadline->format('Y-m-d H:i'))" required />
